        ...
        <section>
            ...
            <div class="container my-8 mx-auto md:px-6">
                    ...
                    <a :href="article.url" target="_blank" class="mb-6 md:my-8 flex flex-wrap"
                        ...
                        <div class="mb-6 ml-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-3/12">
                            <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20"
                                ...
                                <img src="https://www.cnet.com/a/img/resize/c42407724cc95212f33d957ca8532c89e6de31bc/hub/2023/10/06/cddadd21-8e08-46fe-af07-13a2d9f93ba3/gettyimages-1699826003.jpg?auto=webp&fit=crop&height=675&width=1200" class="w-full" :alt="article.description" />
                                <a href="#!">
                                    <div
                        ...
                        <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
                            <h5 class="mb-3 text-lg font-bold">{{ article.description }}</h5>
                            <div
                ...
                <section class="mb-32 text-center md:text-left">
                    ...
                    <a :href="article.webUrl" target="_blank" class="mb-6 md:my-8 flex flex-wrap"
                        v-for="(article, index) of news" :key="index">
                        <!-- <div class="mb-6 ml-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-3/12">
                            <div class="relative mb-6 overflow-hidden rounded-lg bg-cover bg-no-repeat shadow-lg dark:shadow-black/20"
                                data-te-ripple-init data-te-ripple-color="light">
                                <img src="https://www.cnet.com/a/img/resize/c42407724cc95212f33d957ca8532c89e6de31bc/hub/2023/10/06/cddadd21-8e08-46fe-af07-13a2d9f93ba3/gettyimages-1699826003.jpg?auto=webp&fit=crop&height=675&width=1200" class="w-full" :alt="article.description" />
                        ...
                        <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
                            <h5 class="mb-3 text-lg font-bold">{{ article.webTitle }}</h5>
                            <div
                                class="mb-3 flex items-center justify-center text-sm font-medium text-danger dark:text-danger-500 md:justify-start">
                                <!-- <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor" class="mr-2 h-5 w-5">
                            ...
                            <p class="mb-6 text-neutral-500 dark:text-neutral-300">
                                <small>Published <u>{{ new Date(article.webPublicationDate) }}</u>
